...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url=''),
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Owner 🤖', url='https://t.me/lucifercontact_bot')
        ], [
            ...
            InlineKeyboardButton('⪦ Free ai logo maker ⪧', url='https://t.me/ChatGPT2112_bot?start=5390385209')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/digitalhub04'),
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 REPORT BUG 🐞", url=f"https://telegram.me/lucifercontact_bot")
            ],[
                InlineKeyboardButton(text=f"⚡️ Free ai logo maker 🦋", url=f"https://t.me/ChatGPT2112_bot?start=5390385209")
