...
BOT_TOKEN = environ.get('BOT_TOKEN', "6992601655:AAGkcnUNIY8K7nNTthxbTZHhRp7HOgvHIQ8")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ibrahim:ibrahim@cluster0.yuwvjzb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
PORT = int(environ.get('PORT', 8054))
...
FQDN= 'storage.lucifercloud.app'
FQD = ('FQDN', BIND_ADRESS) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
